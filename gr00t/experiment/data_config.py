...
class KUAVOFULLBODYDataConfig(BaseDataConfig):
    video_keys = ["video.ego_view", "video.left_hand_camera", "video.right_hand_camera"]
    state_keys = [
        "state.left_arm", 
        "state.right_arm", 
        "state.left_hand", 
...
class KUAVOFULLUPPERBODYDataConfig(BaseDataConfig):
    video_keys = ["video.ego_view", "video.left_hand_camera", "video.right_hand_camera"]
    state_keys = [
        "state.left_arm", 
        "state.right_arm", 
...
DATA_CONFIG_MAP = {
    ...
    "kuavo_full_body": KUAVOFULLBODYDataConfig(),
    "kuavo_full_upper_body": KUAVOFULLUPPERBODYDataConfig(),
}
